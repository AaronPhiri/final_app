...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { description: @system.description, system_id: @system.system_id, system_name: @system.system_name }
    end
  ...
  test "should update system" do
    patch :update, id: @system, system: { description: @system.description, system_id: @system.system_id, system_name: @system.system_name }
    assert_redirected_to system_path(assigns(:system))
  end
